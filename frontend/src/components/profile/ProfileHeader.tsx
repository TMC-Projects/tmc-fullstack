            ...
            <div>
              ...
              <div className="flex flex-col gap-1 mt-1">
                ...
                <div className="flex items-center justify-center md:justify-start gap-2">
                  <span className="text-xs text-slate-500 dark:text-slate-500 font-mono">ID: {user.id}</span>
                  <button
                    onClick={() => {
                      navigator.clipboard.writeText(String(user.id));
                      showAlert('User ID copied to clipboard', 'success');
                    }}
                    className="p-1 hover:bg-slate-200 dark:hover:bg-slate-800 rounded-md transition-colors text-slate-400 hover:text-slate-600 dark:hover:text-slate-300"
                    title="Copy User ID"
                  >
