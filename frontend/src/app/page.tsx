...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F19] text-slate-200 font-sans selection:bg-purple-500/30 overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0B0F19]/80 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            <img src="/logo.png" alt="TMC Logo" className="w-8 h-8 rounded-lg object-contain" />
          ...
          <div className="hidden lg:flex items-center gap-6">
            <Link href="#marketplace" className="text-sm font-medium text-slate-400 hover:text-white transition-colors">{t('nav_marketplace')}</Link>
            <Link href="#scouting" className="text-sm font-medium text-slate-400 hover:text-white transition-colors">{t('nav_scouting')}</Link>
            <Link href="#management" className="text-sm font-medium text-slate-400 hover:text-white transition-colors">{t('nav_management')}</Link>
            <Link href="#pricing" className="text-sm font-medium text-slate-400 hover:text-white transition-colors">{t('nav_pricing')}</Link>
          </div>

          {/* Desktop CTA */}
          <div className="hidden lg:flex items-center gap-4">
            <div className="flex items-center gap-2 border-r border-slate-700 pr-4">
              <button onClick={() => { document.cookie = 'NEXT_LOCALE=id; path=/'; window.location.reload(); }} className="text-xs font-medium text-slate-400 hover:text-white transition-colors">ID</button>
              <span className="text-slate-700">|</span>
              <button onClick={() => { document.cookie = 'NEXT_LOCALE=en; path=/'; window.location.reload(); }} className="text-xs font-medium text-slate-400 hover:text-white transition-colors">EN</button>
            </div>
            ...
            <div className="flex items-center gap-3 border-r border-slate-700 pr-4">
              ...
              <Link href="/app/register" className="px-4 py-2 bg-slate-800 hover:bg-slate-700 text-white text-sm font-semibold rounded-lg shadow transition-colors border border-slate-700">
                {t('nav_player_register')}
              </Link>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <Link href="/portal/register" className="px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-400 hover:to-purple-500 text-white text-sm font-semibold rounded-lg shadow-lg shadow-purple-500/25 transition-all hover:scale-105 active:scale-95 whitespace-nowrap">
                {t('nav_club_register')}
              </Link>
            </div>
          </div>
        ...
        {/* Mobile Nav */}
        {isMobileMenuOpen && (
          <div className="md:hidden bg-[#0B0F19] border-b border-white/5 px-6 py-6 space-y-4">
            <Link href="#marketplace" className="block text-slate-400 hover:text-white font-medium">{t('nav_marketplace')}</Link>
            <Link href="#scouting" className="block text-slate-400 hover:text-white font-medium">{t('nav_scouting')}</Link>
            <Link href="#management" className="block text-slate-400 hover:text-white font-medium">{t('nav_management')}</Link>
            <Link href="#pricing" className="block text-slate-400 hover:text-white font-medium">{t('nav_pricing')}</Link>

            <div className="pt-4 border-t border-white/10 flex items-center gap-4 justify-center">
              <button onClick={() => { document.cookie = 'NEXT_LOCALE=id; path=/'; window.location.reload(); }} className="text-sm font-medium text-slate-400 hover:text-white transition-colors">ID</button>
              <span className="text-slate-700">|</span>
              <button onClick={() => { document.cookie = 'NEXT_LOCALE=en; path=/'; window.location.reload(); }} className="text-sm font-medium text-slate-400 hover:text-white transition-colors">EN</button>
            </div>
            ...
            <div className="pt-4 border-t border-white/10 flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Link href="/app/register" className="w-full text-center px-4 py-2 bg-slate-700 text-white font-semibold rounded-lg">{t('nav_player_register')}</Link>
      ...
      <section className="relative pt-40 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center z-10">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-800/50 border border-slate-700/50 text-xs font-semibold text-slate-300 tracking-widest uppercase mb-8 backdrop-blur-sm">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="group relative p-[1px] rounded-2xl bg-gradient-to-b from-slate-700 to-slate-800/50 overflow-hidden">
              ...
              <div className="h-full bg-[#111624] p-8 rounded-2xl">
              ...
              <div className="h-full bg-[#111624] p-8 rounded-2xl">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center p-3 bg-slate-900/50 rounded-lg border border-slate-800">
                    ...
                    <span className="font-mono font-bold text-white">2.45</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-slate-900/50 rounded-lg border border-slate-800">
      ...
      <section id="marketplace" className="py-24 bg-[#0F1420]">
        <div className="max-w-7xl mx-auto px-6">

          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-3">{t('tm_title')}</h2>
              <p className="text-slate-400">{t('tm_desc')}</p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {/* Player Card 1 */}
            <div className="bg-[#151A28] rounded-2xl p-6 border border-slate-800 hover:border-slate-700 transition-colors flex flex-col h-full">
              <div className="flex items-start justify-between mb-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-slate-500 font-mono mt-1 block">ID: TMC-8831</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex gap-2">
                  <div className="px-2 py-1 bg-slate-800 rounded border border-slate-700 text-xs font-mono">C9</div>
                  <div className="px-2 py-1 bg-slate-800 rounded border border-slate-700 text-xs font-mono">TL</div>
                </div>
              </div>

              <div className="mt-auto">
                <Link href="/portal/register" className="block w-full py-3 text-center text-sm font-medium text-slate-300 bg-slate-800/50 hover:bg-slate-700/50 rounded-lg transition-colors border border-slate-700">
                  {t('tm_view_profile')}
                </Link>
              </div>
            </div>
            ...
            <div className="bg-[#151A28] rounded-2xl p-6 border-2 border-cyan-500/30 hover:border-cyan-500/50 transition-colors flex flex-col h-full relative overflow-hidden shadow-[0_0_30px_rgba(6,182,212,0.05)]">
              ...
              <div className="flex items-start justify-between mb-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-slate-500 font-mono mt-1 block">ID: TMC-9924</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6">
                <span className="block text-[10px] text-slate-500 uppercase tracking-wider mb-2">{t('tm_interested')}</span>
                <div className="flex gap-2">
                  <div className="px-2 py-1 bg-slate-800 rounded border border-slate-700 text-xs font-mono">SEN</div>
                </div>
              </div>
              ...
              <div className="flex items-start justify-between mb-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-slate-500 font-mono mt-1 block">ID: TMC-4420</span>
                  </div>
                </div>
              </div>
      ...
      <section id="pricing" className="py-24 relative z-10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <div className="inline-flex items-center p-1 bg-slate-900/80 rounded-xl border border-slate-800">
              <button
                onClick={() => setBillingCycle('monthly')}
                className={`px-6 py-2.5 rounded-lg text-sm font-semibold transition-all ${billingCycle === 'monthly' ? 'bg-cyan-500/20 text-cyan-400 shadow-sm' : 'text-slate-400 hover:text-slate-200'}`}
              >
                {t('price_monthly')}
              </button>
              <button
                onClick={() => setBillingCycle('yearly')}
                className={`px-6 py-2.5 rounded-lg text-sm font-semibold transition-all ${billingCycle === 'yearly' ? 'bg-cyan-500/20 text-cyan-400 shadow-sm' : 'text-slate-400 hover:text-slate-200'}`}
              >
          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-[#151A28] rounded-3xl p-8 border border-slate-800 hover:border-cyan-500/50 transition-colors flex flex-col relative overflow-hidden">
              <div className="mb-8">
                <h3 className="text-xl font-bold text-slate-200 mb-2">{t('price_player_title')}</h3>
                <p className="text-sm text-slate-400">{t('price_player_desc')}</p>
              </div>
              <div className="mb-8">
                <div className="flex items-end gap-2 mb-2">
                  <span className="text-4xl font-bold text-white">{t('price_player_price')}</span>
            ...
            {/* Club Plan */}
            <div className="bg-[#111624] rounded-3xl p-8 border-2 border-purple-500/30 hover:border-purple-500/50 transition-colors flex flex-col relative overflow-hidden shadow-[0_0_40px_rgba(168,85,247,0.1)]">
              <div className="absolute top-0 right-0 px-3 py-1 bg-purple-500/20 text-purple-400 text-xs font-bold rounded-bl-xl border-b border-l border-purple-500/30">
                {t('price_club_badge')}
              </div>
              <div className="mb-8">
                <h3 className="text-xl font-bold text-white mb-2">{t('price_club_title')}</h3>
                <p className="text-sm text-slate-400">{t('price_club_desc')}</p>
              </div>
              <div className="mb-8">
                <div className="flex items-end gap-2 mb-2">
                  <span className="text-4xl font-bold text-white">${billingCycle === 'monthly' ? t('price_club_monthly') : t('price_club_yearly')}</span>
                  <span className="text-slate-500 mb-1">/{billingCycle === 'monthly' ? t('price_monthly').toLowerCase() : t('price_yearly').toLowerCase()}</span>
                </div>
              </div>
              <ul className="space-y-4 mb-8 flex-1 text-sm text-slate-300">
                <li className="flex gap-3"><Check className="w-5 h-5 text-purple-400 shrink-0" /> {t('price_club_feat_1')}</li>
                <li className="flex gap-3"><Check className="w-5 h-5 text-purple-400 shrink-0" /> {t('price_club_feat_2')}</li>
                <li className="flex gap-3"><Check className="w-5 h-5 text-purple-400 shrink-0" /> {t('price_club_feat_3')}</li>
                <li className="flex gap-3"><Check className="w-5 h-5 text-purple-400 shrink-0" /> {t('price_club_feat_4')}</li>
              </ul>
      ...
      {/* --- Footer --- */}
      <footer className="border-t border-slate-800 bg-[#0B0F19] pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-12">
            <div className="flex items-center gap-3">
              <img src="/logo.png" alt="TMC Logo" className="w-6 h-6 rounded object-contain grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all" />
            ...
            <div className="flex flex-wrap justify-center gap-6 text-sm text-slate-400">
              ...
              <Link href="#" className="hover:text-white transition-colors">{t('footer_tos')}</Link>
              <Link href="#" className="hover:text-white transition-colors">{t('footer_cookie')}</Link>
              <Link href="#" className="hover:text-white transition-colors">{t('footer_contact')}</Link>
              <Link href="#" className="hover:text-white transition-colors">{t('footer_api')}</Link>
            </div>
          </div>

          <div className="text-center md:text-right text-xs text-slate-600 flex flex-col md:flex-row items-center justify-between border-t border-slate-800/50 pt-8">
