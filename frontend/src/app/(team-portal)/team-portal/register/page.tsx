...
export default function TeamPortalRegisterPage() {
  const router = useRouter();
  const setAuth = useAuthStore((state) => state.setAuth);
  const t = useTranslations('TeamAuth');
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="bg-slate-100/60 dark:bg-slate-900/60 border border-slate-300/80 dark:border-slate-800/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* Category Field is hidden for team-portal */}
            <input type="hidden" id="category" value="team_owner" />
